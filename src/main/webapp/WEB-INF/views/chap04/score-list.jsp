    ...
    <div class="container">
       <h1>전체 학생 성적 목록</h1> 
            ...
            <tbody>
                ...
                <c:forEach var="score" items="${scoreList}">
                    <tr>
                        ...
                        <td><a href="http://localhost:8080/score/detail?studentNumber=${score.studentNumber}">${score.name}</a></td>
        ...
        <form action="/score/register" method="POST">
            ...
            <input type="number" class="form-control" id="user-ebg" name="engScore" min="0">
